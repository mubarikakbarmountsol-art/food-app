      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-orange-50 to-red-50 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-center items-center text-center p-12 text-white">
          <div className="flex items-center space-x-3 mb-8">
            ...
            <span className="text-4xl font-bold">grocyon</span>
          </div>
          ...
          <div className="max-w-md">
            ...
            <p className="text-xl text-gray-200">
              Join our platform and start managing your restaurant business
              today
            </p>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white overflow-y-auto">
        <div className="max-w-md w-full">
          ...
          <div className="text-center lg:text-right mb-8">
            ...
            <p className="text-gray-600 mb-4">Join grocyon Platform</p>
