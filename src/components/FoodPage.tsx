            ...
            <div className="relative">
              ...
              <div className="absolute top-4 left-4 flex space-x-2">
                <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                  selectedFood.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'
                }`}>
                  {selectedFood.status}
                </span>
                <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                  selectedFood.inStock ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800'
                }`}>
            ...
            <div className="p-6">
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  <div className="text-3xl font-bold text-red-600">${selectedFood.price}</div>
                  <div className="flex items-center space-x-1 mt-1">
                    <Star className="w-5 h-5 text-yellow-400 fill-current" />
                    <span className="text-lg font-medium text-gray-700">{selectedFood.rating}</span>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {['Tomato', 'Cheese', 'Basil', 'Olive Oil', 'Garlic', 'Oregano'].map((ingredient, index) => (
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-4 gap-4">
                  <div className="text-center p-3 bg-orange-50 rounded-lg">
                    <div className="text-xl font-bold text-orange-600">320</div>
                    <div className="text-sm text-orange-700">Calories</div>
                  </div>
                  <div className="text-center p-3 bg-green-50 rounded-lg">
                    <div className="text-xl font-bold text-green-600">12g</div>
                  ...
                  <div className="text-center p-3 bg-purple-50 rounded-lg">
                    <div className="text-xl font-bold text-purple-600">18g</div>
