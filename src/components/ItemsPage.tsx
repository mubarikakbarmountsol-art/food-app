      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-2">🍽️ Items Management</h1>
          ...
          <div className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6">
              <div className="flex items-start space-x-6 mb-6">
                ...
                />
                <div className="flex-1">
                  <h2 className="text-3xl font-bold text-gray-800 mb-2">{selectedItem.itemName}</h2>
                  <p className="text-lg text-gray-600 mb-4">{selectedItem.shortDescription}</p>
                  <div className="flex flex-wrap gap-2">
                    {selectedItem.categoryIds.map((categoryId) => {
                      const category = categories.find(cat => cat.id === categoryId);
                      return category ? (
                        <span key={categoryId} className="px-3 py-1 bg-blue-50 text-blue-700 rounded-full text-sm">
                          {category.categoryName}
                        </span>
                      ) : null;
                    })}
