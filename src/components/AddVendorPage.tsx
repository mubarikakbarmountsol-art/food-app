...
import { User, Mail, Phone, MapPin, Building, Save, X, ArrowLeft } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="mt-4">
          ...
          <p className="text-gray-600">Create a new vendor account for restaurant partners</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600">
              By creating this vendor account, you agree that the vendor will comply with all platform policies, 
              maintain food quality standards, and provide timely service to customers.
            </p>
          </div>
