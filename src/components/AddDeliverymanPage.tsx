...
import { User, Mail, Phone, MapPin, Save, X, ArrowLeft, Loader, Building, FileText, Lock } from 'lucide-react';
...
export default function AddDeliverymanPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : 'Failed to create delivery driver');
    } finally {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6">
        ...
        <div className="mt-4">
          <h1 className="text-2xl font-bold text-gray-800">Add New Delivery Driver</h1>
          <p className="text-gray-600">Create a new account for a delivery driver</p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => handleInputChange('agreement_docs', e.target.value)}
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500"
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            ...
            <p className="text-sm text-gray-600">
              By creating this delivery driver account, you agree that the driver will
              comply with all platform policies, maintain professional conduct,
              and provide timely delivery service to customers.
            </p>
          </div>
          ...
          <div className="flex space-x-4 pt-6">
            ...
            >
              ...
              <span>{isSubmitting ? 'Creating...' : 'Create Delivery Driver'}</span>
            </button>
            <button
              type="button"
              onClick={handleBack}
